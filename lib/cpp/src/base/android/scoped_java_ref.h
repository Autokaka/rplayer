...
class JavaRef<jobject> {
 ...
 protected:
  // Initializes a nullptr reference.
  JavaRef();
...
class ScopedJavaLocalRef : public JavaRef<T> {
 public:
  explicit ScopedJavaLocalRef() = default;
  ...
  // copy constructor.
  ScopedJavaLocalRef<T>& operator=(const ScopedJavaLocalRef<T>& other) {
    this->Reset(other);
    return *this;
  }
  ...
  void Reset(const U& other) {
    // If |env_| was not yet set (is still nullptr) it will be attached to the
...
class ScopedJavaGlobalRef : public JavaRef<T> {
 public:
  explicit ScopedJavaGlobalRef() = default;
  ...
  ScopedJavaGlobalRef<T>& operator=(const ScopedJavaGlobalRef<T>& other) {
    this->Reset(other);
    return *this;
  }
